...
def drawMoveCounter(numMoves):
    font = pygame.font.Font(None, 36)  # 36 px font
    text = font.render(f"Moves: {numMoves}", True, WHITE)
    DISPLAYSURF.blit(text, (10, 10))  # top-left corner
